...
import { BRAND, VALUE_PROPS } from '@/lib/constants'
  ...
  return (
    <section className="relative overflow-hidden pt-28 pb-16 lg:pt-36 lg:pb-28">
      ...
      >
        ...
        >
          Beyond colors, we design experiences
        </motion.h1>
        ...
        >
          ...
          execution support — tailored for builders, site engineers, commercial
        ...
        >
          {VALUE_PROPS.map((item) => (
            <div key={item.title}>
              <p className="font-display text-xl font-semibold text-charcoal lg:text-2xl">
                {item.title}
              </p>
